...
par( mfrow=c(2,2)) # Multiple plots, 2 accross, 2 down

# Plot 1
plot( power1$DateTime, power1$Global_active_power, xlab="", ylab="Global Active Power", type = "n"   )
lines( power1$DateTime, power1$Global_active_power, type="l", col = "black" ) 

#Plot 2
plot( power1$DateTime, power1$Voltage, xlab="datetime", ylab="Voltage", type = "n"   )
lines( power1$DateTime, power1$Voltage, type="l", col = "black" ) 
...
#plot 4
plot( power1$DateTime, power1$Global_reactive_power, xlab="datetime", ylab="Global_Reactive_Power", type = "n"   )
lines( power1$DateTime, power1$Global_reactive_power, type="l", col = "black" ) 


dev.copy( png, filename = "plot4.png", width=480, height=480 )
dev.off()

cat("C4A1_Plot4.R Finished\n") 
